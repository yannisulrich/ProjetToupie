...
public:
    ...
    TippeTopRolls(SupportADessin* support, const Vecteur5& P, const Vecteur5& P_dot, const double& R, const double& h, const double& m, const QString& modelpath = "", const bool& external = false):
