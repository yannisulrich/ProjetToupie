...
int main() {
    ...
    Simulator simulator(true, &integR, 60, 100, v, 50);
    //simulator.system->addSymCone(Vecteur5(0.01, 0, 0, 0, 0), Vecteur5(0, 0, 100, 0, 0), 3, 0.9, 4000);
    ...
    simulator.system->addSymConeGlisse(Vecteur5(0.05, 0, 0.00001, 0, 0), Vecteur5(0, 0, 100, 0, 0.09), 0.03, 0.02, 0.008, 0.01);
