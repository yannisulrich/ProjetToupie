...
int main() {
    ...
    systeme.addConeSymFixe(Vecteur5(0.5,0,0,0,0),Vecteur5(0,0,60,0,0), 1.0, 1.0, 0.127);
    ...
    fprintf(gnuplotPipe, "plot '/Users/yannis/Desktop/EPFL/ICC2/Exercices/ProjetToupie/Tests/SystemeOutputGrep1.txt' "
                         "using ($0/20.):1 w lp, '/Users/yannis/Desktop/EPFL/ICC2/Exercices/ProjetToupie/Tests/SystemeOutputGrep1.txt' using ($0/20.):2 w lp \n");
    fflush(gnuplotPipe);
